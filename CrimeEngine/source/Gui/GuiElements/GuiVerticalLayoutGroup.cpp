#include "cepch.h"
#include "Gui/GuiElements/GuiVerticalLayoutGroup.h"

namespace ce
{
	GuiVerticalLayoutGroup::GuiVerticalLayoutGroup(GuiElement* a_parent, bool a_controlChildWidth /*= true*/, bool a_controlChildHeight /*= true*/) :
		GuiElement(a_parent)
	{
	...
	void GuiVerticalLayoutGroup::OnLayoutChange()
	{
		Vector2 s = GetSize();
		Vector2 ls{ 0, 0 };
		...
		if (ch > 0)
		{
			ls.y = ls.y - (m_spacing * float(ch - 1));
		}
