...
void cr::DX12_CommandList::Reset(unsigned int a_frame, DX12_PSO* a_pso)
{
...
Microsoft::WRL::ComPtr<ID3D12CommandAllocator> cr::DX12_CommandList::GetCurrentAllocator(unsigned int a_id)
{
